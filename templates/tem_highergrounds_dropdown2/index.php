...
<head>
	...
	<link rel="stylesheet" href="<?php echo $this->baseurl ?>/templates/<?php echo $this->template ?>/css/suckerfish.css" type="text/css" />
...
<div id="wrap">
	...
	<div id="header">			
		...
		<h2 id="slogan">Helping people use bicycles</h2>		
