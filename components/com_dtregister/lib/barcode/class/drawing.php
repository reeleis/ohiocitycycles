 ...
 */
include_once(dirname(__FILE__).'/barcode.php');
include_once(dirname(__FILE__).'/drawjpg.php');
include_once(dirname(__FILE__).'/drawpng.php');


class BCGDrawing {
	const IMG_FORMAT_PNG = 0;
	const IMG_FORMAT_JPEG = 1;
	const IMG_FORMAT_GIF = 2;
	const IMG_FORMAT_WBMP = 3;
