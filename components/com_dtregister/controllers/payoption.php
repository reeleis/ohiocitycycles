...
class DtregisterControllerPayoption extends DtrController {
  ...
  var $name ='payoption';
   function __construct($config = array()){
	     $config = array('default_task'=>'payments','task_map'=>array('new'=>'add'));
   ...
   function save(){
	...
	$mainframe->redirect( "index.php?option=com_dtregister&controller=payoption&Itemid=".$Itemid ,JText::_( 'DT_PAYMENT_SAVED') );
	}
