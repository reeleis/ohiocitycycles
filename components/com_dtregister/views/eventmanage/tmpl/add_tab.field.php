		      ...
		      <?php
		      	...
		      	?>
		      		...
		      		<tr>
						 ...
						 echo JHTML::_('select.genericlist', $options, "data[field][".$rowField->id."][showed]",' class="fields" ','value','text',$showed);
						...
						?>
                        <td><?php  echo JHTML::_('select.genericlist',$options,"data[field][".$rowField->id."][required]","",'value','text',$required); ?></td>
                ...
                <td>
		      		  ...
		      		  <?php
						    ...
						    $options[]=JHTML::_('select.option',"3",JText::_( 'DT_MEMBERS_BILLING'));
							  ...
							  echo JHTML::_('select.genericlist', $options, 'data[field]['.$rowField->id.'][group_behave]','','value','text',$group);
