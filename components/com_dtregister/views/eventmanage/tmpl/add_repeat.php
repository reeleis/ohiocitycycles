...
<tr id='repeatrow'>
  ...
  <td colspan="3">
      ...
      <?php
		...
		echo JHTML::_('select.radiolist', $options, "data[event][repeatType]",' class="repeatType" ','value','text','norepeat');
         ...
         <span id='common'>
            ...
            <span id='spanrpinterval' style="display:none">
             ...
             <span id='spanrpcount'>
               ...
               <input type="radio" name='data[event][countselector]' id="rpcountselect" value="count" class ='countselector' />

               <input type="text" name="data[event][rpcount]" id='rpcount' size="5" />
           ...
           <span id='spanrpuntil' >
             ...
             <input type="radio" name='data[event][countselector]' id="rpuntilselector" value="until" class = 'countselector' />

             <?php

               echo JHTML::_("calendar",'',"data[event][rpuntil]","rpuntil");
         ...
         <br />
          ...
          <span id='weekly'>
              ...
              <?php echo JText::_('DT_BY_DAYS')?>: <?php
			   ...
			   echo DtHtml::checkboxList('data[event][weekdays]',$options);
           ...
           <span id='monthly'>
              ...
              <input type="radio" name='data[event][monthdayselector]' value="monthdays" class='monthdayselector' />

              </td><td valign="top">

              <?php echo JText::_('DT_MONTH_DAYS_COMMA_SEPARATED')?>: 

              <input id='monthdays' type="text" value="" disabled="disabled" name="data[event][monthdays]" />

              </td></tr>

              <tr><td valign="top">

              <input type="radio" name='data[event][monthdayselector]' checked="checked" value="monthweekdays" class='monthdayselector' />
...
<script type="text/javascript" >
   ...
   DTjQuery(function(){
	    ...
	    DTjQuery('.repeatType').change(function(){
			...
			DTjQuery("#rpcountselect").trigger('change');
