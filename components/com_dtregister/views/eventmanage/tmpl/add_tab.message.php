...
<table class="adminform" width="100%" cellpadding="10" cellspacing="10">
      ...
      <tr align="center" valign="middle">
       ...
       <td width="400" align="left" valign="top" style="width:620px"><?php echo $editor->display("data[event][topmsg]",stripslashes($row->topmsg),'','','50','20','0'); ?></td>
      ...
      <td align="left" valign="top"><strong><?php echo JText::_( 'DT_EVENT_DESCRIPTION' ); ?>:</strong>
     	...
     	<td align="left" valign="top"><?php echo $editor->display("data[event][event_describe]",stripslashes($row->event_describe),'','','50','20','0'); ?></td>
      ...
      <tr align="center" valign="middle">
     	...
     	<td align="left" valign="top">
		      <?php echo $editor->display("data[event][thanksmsg]",stripslashes($row->thanksmsg),'','','50','20','0'); ?>
      </td>
      ...
      <td align="left" valign="top"><strong><?php echo JText::_( 'DT_EVENT_PAYLATER_THANK' ); ?>:</strong>
     	...
     	<td align="left" valign="top">
	     <?php echo $editor->display("data[event][pay_later_thk_msg]",stripslashes($row->pay_later_thk_msg),'','','50','20','0'); ?>
      </td>
    ...
    <tr align="center" valign="middle">
      ...
      <td align="left" valign="top"><strong><?php echo JText::_( 'DT_CUSTOM_TERMS_CONDITIONS' ); ?>:</strong>
       ...
       <td align="left" valign="top">
        <?php echo $editor->display("data[event][terms_conditions_msg]",stripslashes($row->terms_conditions_msg),'','','50','20','0'); ?>
      </td>
