...
<table width="100%" class="adminlist">
  ...
  <tr>
    ...
    <th class="dt_heading" nowrap><?php echo JText::_( 'DT_NAME');  ?></a>  </th>

    <th class="dt_heading" nowrap>
  ...
  $i = 0;
    ...
    foreach($locations as $location){
	  	...
	  	$link = 'index.php?option=com_dtregister&task=edit&controller=location&hidematinmenu=1&cid[]='. $location->id;
