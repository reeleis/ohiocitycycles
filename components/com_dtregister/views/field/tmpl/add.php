...
/*
				...
				if(fieldType==6){
					...
					form.textual.disabled=false;



					form.cols.disabled=true;



					form.new_line[0].disabled=true;



					form.new_line[1].disabled=true;
					...
					form.field_size.disabled=false;
					...
					form.cols.disabled=false;



					form.new_line[0].disabled=false;



					form.new_line[1].disabled=false;



				}

                if((fieldType!=0) && (fieldType!=1) && (fieldType!=5))
...

				{
					...
					for(var i=0;i<form.new_line.length;i++)
...

					{
						...
						form.new_line[i].disabled=false;
