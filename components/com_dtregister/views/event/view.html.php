	...
	function userFields($usercreation=0){
	 ...
	 function capthaField(){
	     ...
	     $html = "" ;
	      ...
	      $value = '<input type="text" id="captchaField" name="captcha" value="" class="required" /> <img src="'. JURI::root(true).'/components/com_dtregister/CaptchaSecurityImages.php?width=100'. $amp.'height=40'.$amp.'characters=5" id="captchaelement" align="middle" alt="" /><a href="#" id="captchreload"><img border="" src="'.JUri::root().'/components/com_dtregister/assets/images/'.$button_color.'/reload_20x20.png'.'" /></a><label for="captchaField" style="display:none" generated="true" class="error"></label>
';
          $document = &JFactory::getDocument();
		  ob_start();
		  ?>
