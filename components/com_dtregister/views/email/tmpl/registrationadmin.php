<table>
 ...
 <tr><td><?php  echo  JText::_('DT_CONFIRMATION_NUMBER') ?>: </td><td><?php  echo $this->user->confirmNum; ?></td></tr>
  ...
  <tr><td><?php  echo JText::_('DT_PAYMENT_TYPE') ?>: </td><td><?php  echo $this->paymentmethods[$this->user->fee->payment_method]; ?></td></tr>
...
<?php
 ...
 global $barCodeImagetypeToExt , $barcode_image_type , $barcode_enable ;
  ...
  if($barcode_enable == 1 && $barCodeImagetypeToExt[$barcode_image_type] != ""){
