...
<!--# Category ID ,Category Name, Parent Category, Access Level ,Status, Reorder, Order Delete -->
   <table class="adminlist" align="left" style="width:900px">
       <tr>
           ...
           <th width="20" class="dt_heading"><?php echo JText::_( 'DT_ORDER' );  echo DtHtml::order($rows ); ?></th>
	...
	<?php
	  ...
	  $published = DtHtml::published( $row, $i);
	...
	<tr class="<?php echo "row$k"; ?>">
       ...
       <td>
        ...
        <span><?php echo DtHtml::orderUpIcon( $i, true, 'orderup', 'Move Up' , true, $pageNav ); ?></span>

       </td>

		<td>

        <span><?php echo DtHtml::orderDownIcon( $i, $n ,true,'orderdown', 'Move Down',true, $pageNav); ?></span>
