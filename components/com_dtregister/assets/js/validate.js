...
$.extend($.fn, {
	...
	rules: function(command, argument) {
		...
		if (command) {
			...
			var settings = DTjQuery.data(element.form, 'validator').settings;
...
;(function($) {
	...
	if (!DTjQuery.event.special.focusin && !DTjQuery.event.special.focusout && document.addEventListener) {
...
function DTselected(cal, date) {
	...
	DTjQuery(cal.sel.form).validate().element( cal.sel );
...
function DTshowCalendar(id, dateFormat) {
