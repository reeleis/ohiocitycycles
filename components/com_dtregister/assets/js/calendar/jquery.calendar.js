...
; (function($) {
    ...
    $.fn.bcalendar = function(option) {
        ...
        var __ALLDAYEVENTTEMP = '<div class="rb-o ${eclass}" id="${id}" title="${title}" style="color:${color};"><div class="dhdV" style="display:none">${data}</div><div class="${extendClass} rb-m" style="background-color:${color}">${extendHTML}<div class="rb-i" ${wrapstyle} >${content}</div></div></div>';
        ...
        function BuildDaysAndWeekView(startday, l, events, config) {
            ...
            html.push("<div id=\"dvtec\"  class=\"scolltimeevent\"><table style=\"table-layout: fixed;", DTjQuery.browser.msie ? "" : "width:100%", "\" cellspacing=\"0\" cellpadding=\"0\"><tbody><tr><td>");
...
//console.log(ret.join(""));
        ...
        function BuildMonthDayEvent(e, cday, length) {
            ...
            if(option.wrapTitle){
				p.wrapstyle = 'style="white-space:normal"';
			}else{
				p.wrapstyle = "";
			}
        ...
        function Tp(temp, dataarry) {
            ...
            var ret =  temp.replace(/\$\{([\w]+)\}/g, function(s1, s2) { var s = dataarry[s2]; if (typeof (s) != "undefined") { return s; } else { return s1; } });
