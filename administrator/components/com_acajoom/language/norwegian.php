...
// messages
define('_ACA_ERROR' , ' En feil oppsto! ');
...
define('_ACA_SUB_INFO', 'Abonnenten\'s informasjon');
...
define('_ACA_LIST_ISSUE', 'Utgave #');
define('_ACA_LIST_DATE', 'Sende dato');
define('_ACA_LIST_SUB', 'Nyhetsbrev tema');
