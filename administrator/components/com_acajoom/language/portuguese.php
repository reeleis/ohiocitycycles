...
define('_ACA_MENU_UPDATE', 'Importar');
...
define('_ACA_UNSUBSCRIBE', 'Remover subscrição');
...
define( '_ACA_MAIL_FORMAT', 'Formato de codificação' );
define( '_ACA_MAIL_FORMAT_TIPS', 'Que formato utiliza para codificar os mailings, somente texto ou MIME' );
...
//since 1.3.1
define('_ACA_SHOW_AUTHOR', 'Mostrar nome do autor');
define('_ACA_SHOW_AUTHOR_TIPS', 'Seleccione Sim se pretende adicionar o nome do autor quando adiciona um artigo ao Mailing');
...
//since 1.5.6
define('_ACA_ADDEMAILREDLINK_TIPS','Se seleccionar Sim o e-mail do utilizador será adicionado como parametro no final do url redireccionado (o link redireccionado para o seu modulo or para um formulário Acajoom externo).<br/>Pode ser útil se pretender executar scripts especiais na sua página redireccionada.');
define('_ACA_ADDEMAILREDLINK','Adicionar e-mail para redireccionar link');
...
define('_ACA_REDIRECTCONFIRMATION','URL redireccionado');
define('_ACA_REDIRECTCONFIRMATION_TIPS','Se requer um e-mail de confirmação, o utilizador quando confirmar será remetido para este URL.');
