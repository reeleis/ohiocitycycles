...
<table cellpadding="4" cellspacing="1" border="1" width="100%" class="adminform">
    ...
    <tr><td align="left"><?php echo JText::_( 'DT_EVENT_OWNER' ); ?>:</td>
    ...
    <tr id="jeventrow">
        ...
        <td align="left"><?php echo JText::_( 'DT_SELECT_JEVENT' ); ?>:</td>
     ...
     <?php
	  ...
	  ?>
       <tr id="timerow">
      	...
      	<td align="left"><?php echo JText::_( 'DT_EVENT_TITLE' ); ?>:</td>
   ...
   <tr>
	 ...
	 <td align="left"><?php echo JText::_( 'DT_EVENT_CATEGORY' ); ?>:</td>
    ...
    <td colspan="2">&nbsp;&nbsp;<?php echo JHTML::tooltip((JText::_( 'DT_EVENT_CATEGORY_HELP' )), '', 'tooltip.png', '', ''); ?></td>
      ...
      <tr>
        ...
        <td align="left"><?php echo JText::_( 'DT_EVENT_LOCATION' ); ?>:</td>

        <td>

 			  <?php 

              $locationsOpts = DtHtml::options($location->optionslist(),JText::_('DT_SELECT_LOCATION'));
   ...
   <tr align="center" valign="middle" >
	  ...
	  <td align="left" valign="top"><?php echo JText::_( 'DT_TIME_FORMAT' );?>:</td>
       ...
       <tr id="timerow">
      	...
      	<td align="left"><?php echo JText::_( 'DT_EVENT_START' ); ?>:</td>
...
onclick="return DTshowCalendar('dtstart','%Y-%m-%d');" />
			...
			<input type="text" class="timeEntry checkdate " id="dtstarttime" name="data[event][dtstarttime]" value="<?php echo $row->dtstarttime; ?>" readonly="readonly" />&nbsp;
       ...
       <tr id="timerow">
      	...
      	<td align="left"><?php echo JText::_( 'DT_EVENT_END' ); ?>:</td>

      	<td>
            <input type="text" class="" id="dtend" name="data[event][dtend]" value="<?php echo $row->dtend; ?>" readonly="readonly">
...
onclick="return DTshowCalendar('dtend','%Y-%m-%d');" />
            ...
            <input type="text" readonly="readonly" class="timeEntry checkdate" id="dtendtime" name="data[event][dtendtime]" value="<?php echo $row->dtendtime; ?>" />
      ...
      <tr>
	  	 ...
	  	 <td align="left"><?php echo JText::_( 'DT_SEND_NOTIFICATION_TO' ); ?>:</td>
      ...
      <tr>
        ...
        <td align="left"><?php echo JText::_( 'DT_REGISTRATION_TYPE' ); ?>:</td>
        ...
        <td>
			 ...
			 // $options[]=JHTML::_('select.option',"no",JText::_('DT_NO_REGISTRATION'));
      ...
      <tr id="grouptype">
        ...
        <td align="left"><?php echo JText::_( 'DT_GROUP_REG_TYPE' ); ?>:</td>
      ...
      <td align="left"><?php echo JText::_( 'DT_PUBLIC_LIST' ); ?>:</td>
      ...
      <tr>
        ...
        <td align="left"><?php echo JText::_( 'DT_EVENT_MAX_REGISTRATION' ); ?>:</td>
    ...
    <tr align="center" valign="middle">
     ...
     <tr>
        ...
        <td align="left"><?php echo JText::_( 'DT_REGISTRATION_OPEN_DATE' ); ?>:</td>
      ...
      <tr>
        ...
        <td align="left"><?php echo JText::_( 'DT_CUT_OFF_DATE' ); ?>:</td>
      ...
      <td align="left"><?php echo JText::_( 'DT_WAITING_LIST' ); ?>:</td>
    ...
    <td valign="top" align="left"><?php echo JText::_( 'DT_EVENT_CATEGORY_PREREQUISITE' ); ?>:</td>
    ...
    <td colspan="2">&nbsp;&nbsp;<?php echo JHTML::tooltip((JText::_( 'DT_EVENT_CATEGORY_PREREQUISITE_HELP' )), '', 'tooltip.png', '', ''); ?></td>
      ...
      <tr>
        ...
        <td valign="top" align="left"><?php echo JText::_( 'DT_PREREQUISITE' ); ?>:</td>
      ...
      <tr>
        ...
        <td align="left"><?php echo JText::_( 'DT_ARTICLE' ); ?>:</td>
       ...
       <tr>
      	...
      	<td align="left"><?php echo JText::_( 'DT_DETAILS_ITEMID' ); ?>:</td>
      	...
      	<td align="left"><?php echo JText::_( 'DT_EVENT_DETAIL_LINK_DISPLAY' ); ?>:</td>
	  ...
	  <tr>
      	...
      	<td align="left"><?php echo JText::_( 'DT_EVENT_SHOW_REGISTRANT' ); ?>:</td>
        ...
        <td>
                   ...
                   <?php
							...
							$options[]=JHTML::_('select.option', '0', JText::_( 'Yes' ));
                  			...
                  			echo JHTML::_('select.radiolist', $options,'data[event][prevent_duplication]','','value','text',isset($row->prevent_duplication)?$row->prevent_duplication:1);
          ...
          <td>
                   ...
                   <?php
							...
							$options[]=JHTML::_('select.option', '1', JText::_( 'Yes' ));
                  			...
                  			echo JHTML::_('select.radiolist', $options,'data[event][usetimecheck]','','value','text',isset($row->usetimecheck)?$row->usetimecheck:0);
		...
		<td align="left" valign="top"><?php echo JText::_( 'DT_EXCLUDE_OVERLAP' );?>:</td>
          ...
          <td>
                   ...
                   <?php
							...
							echo JHTML::_('select.radiolist', $options,'data[event][excludeoverlap]','','value','text',isset($row->excludeoverlap)?$row->excludeoverlap:0);
...
<script type="text/javascript">
  ...
  DTjQuery(function(){
   ...
   DTjQuery('#articlesection').change(function(){
	...
	DTjQuery('#category_id').load("index.php?option=com_dtregister&controller=event&no_html=1&sectionId="+DTjQuery(this).val()+"&task=getcategory",article,function(){  
	...
	DTjQuery('#article_id').load("index.php?option=com_dtregister&controller=event&no_html=1&categoryId="+DTjQuery(this).val()+"&task=getarticle",article,function(){
   ...
   DTjQuery(function(){
		...
		?>
		   ...
		   DTjQuery('#category_id').load("index.php?option=com_dtregister&controller=event&no_html=1&sectionId="+article['sectionid']+"&task=getcategory",article,function(){			   

			      DTjQuery('#articlecategory').val(article['catid']);
				  DTjQuery('#article_id').load("index.php?option=com_dtregister&controller=event&no_html=1&categoryId="+article['catid']+"&task=getarticle",article,function(){
