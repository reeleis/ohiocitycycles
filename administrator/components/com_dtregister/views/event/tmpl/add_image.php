 ...
 <td>
    <?php
	 ...
	 if($this->row->imagepath != ""){
		...
		<a class="ajax" href="index.php?option=com_dtregister&task=removeimage&eventId='.$this->row->slabId.'" ><img src="components/com_dtregister/assets/images/delete.jpg" style="height:16px; width:16px; border:0px"></a>';	
