...
<table width="100%" class="adminform" border="1">
   ...
   <tr>
	  ...
	  echo "<img src=\"../index.php?option=com_dtregister&w=".$config->getGlobal('location_img_w',150)."&h=".$config->getGlobal('location_img_h',150)."&task=thumb&no_html=1&controller=file&filename=images/dtregister/locations/".basename($row->image)."\" />";
