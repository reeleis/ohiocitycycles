...
?>
    ...
    <p><?php echo JText::_( 'DT_CUSTOM_FIELD_INSTRUCTIONS' ); ?></p>
		...
		<tr>
			...
			<a href="javascript: saveOrderCustom( <?php echo count( $rows )-1; ?>,'saveorder')"><img src="images/filesave.png" border="0" width="16" height="16" alt="<?php echo JText::_( 'DT_SAVE_ORDER' ); ?>" /></a>
		...
		for ($i=0, $n=count( $rows ); $i < $n; $i++) {
			...
			$link 	= 'index2.php?option='.$option.'&task=edit&controller=field&hidemainmenu=1&cid[]='. $row->id;
