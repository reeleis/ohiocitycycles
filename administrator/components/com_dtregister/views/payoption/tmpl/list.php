...
<table class="adminlist">
  ...
  $i = 0;
    ...
    foreach($payments as $payment){
	  	...
	  	$link 	= 'index2.php?option=com_dtregister&task=edit&controller=payoption&hidematinmenu=1&cid[]='. $payment->id;
     ...
     <td>
       <?php
          if($payment->default){
			  ?>
              <a href="index2.php?option=com_dtregister#deselectdefault"  onclick="return listItemTask('cb<?php echo $i;?>','deselectdefault')">
              <?php
		  ...
		  ?>
			   <a href="index2.php?option=com_dtregister#default" onclick="return listItemTask('cb<?php echo $i;?>','makedefault')"><?php echo JText::_('DT_MAKE_DEFAULT'); ?></a>
          <?php
		  }
	   ?>
     </td>
